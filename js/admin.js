      ...
      <tr style="border-bottom:1px solid #e8e8e4;">
        <td style="padding:8px 12px;">
          <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:4px;">
            <tr>
              <td style="font-size:11px;font-weight:600;color:#555;">Ticket ${t.ticket_number}${t.ticket_number > 3 ? ' <span style="font-size:9px;background:#f5f0e0;color:#8B6914;padding:1px 4px;border-radius:3px;">WHEEL</span>' : ''}</td>
